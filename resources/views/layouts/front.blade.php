                ...
                <form action="{{ route('search') }}" method="GET" class="bg-white dark:bg-dark-surface rounded-2xl shadow-modal border border-border dark:border-dark-border overflow-hidden">
                    <div class="flex items-center gap-3 px-5 py-4">
                        ...
                        <input
                            ...
                            autocomplete="off"
                        >
                        <button type="button" @click="searchOpen = false" class="rounded-lg p-1.5 text-gray-400 hover:bg-gray-100 dark:hover:bg-dark-surface-alt transition" aria-label="Tutup pencarian">
